...
|---------|------|---------|
| Human-facing / codename | MoneyMonkey | "The MoneyMonkey report says HOLD" |
| Repository / package prefix | `aimoneymonkey-*` or `mm-*` | `mm-collector`, `mm-analyzer`, `mm-renderer` |
| Logs / artifacts | `mm-*` | `mm-datapack-2025-12-13.json` |
| Namespace (PHP) | `MoneyMonkey\` | `MoneyMonkey\Handlers\CollectIndustryHandler` |
