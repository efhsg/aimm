    ...
    <header class="pdf-header">
        <div class="pdf-header__left">
            <div class="pdf-header__brand">
                <svg viewBox="0 0 543 474" xmlns="http://www.w3.org/2000/svg" class="pdf-header__logo" aria-hidden="true">
                    <defs>
                ...
                <div class="pdf-header__text">
                    <span class="pdf-header__name">AIMM</span>
                    <span class="pdf-header__tagline">Equity Intelligence Pipeline</span>
                </div>
            </div>
        </div>
        <div class="pdf-header__right">
            <div class="pdf-header__title"><?= htmlspecialchars($title, ENT_QUOTES, 'UTF-8') ?></div>
        </div>
    </header>
</body>
</html>
