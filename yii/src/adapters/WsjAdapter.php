...
/**
 * Adapter for extracting financial data from Wall Street Journal.
 */
final class WsjAdapter implements SourceAdapterInterface
{
    private const ADAPTER_ID = 'wsj';

    private const SELECTORS = [
        'valuation.market_cap' => [
            'selector' => '//*[@data-id="market_cap"]//text()',
            'unit' => 'currency',
        ],
        'valuation.trailing_pe' => [
            'selector' => '//*[@data-id="pe_ratio"]//text()',
            'unit' => 'ratio',
        ],
        'valuation.fwd_pe' => [
            'selector' => '//*[@data-id="forward_pe"]//text()',
            'unit' => 'ratio',
        ],
        'valuation.div_yield' => [
            'selector' => '//*[@data-id="dividend_yield"]//text()',
            'unit' => 'percent',
        ],
        'valuation.price_to_book' => [
            'selector' => '//*[@data-id="price_book"]//text()',
            'unit' => 'ratio',
        ],
    ];
