...
/**
 * Adapter for StockAnalysis HTML pages.
 */
final class StockAnalysisAdapter implements SourceAdapterInterface
{
    use ParsesFinancialValues;

    private const ADAPTER_ID = 'stockanalysis';
    ...
    private const LABEL_MAP = [
        ...
        'valuation.fcf_yield' => [
            'labels' => ['fcf yield', 'free cash flow yield'],
            'unit' => 'percent',
        ],
        ...
        'valuation.free_cash_flow_ttm' => [
            'labels' => ['free cash flow', 'free cash flow (ttm)', 'fcf'],
            'unit' => 'currency',
        ],
    ];
