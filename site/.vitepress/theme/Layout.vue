  ...
  <Layout>
    <template #nav-bar-title-before>
      <span class="docs-brand">
        <svg viewBox="0 0 543 474" xmlns="http://www.w3.org/2000/svg" class="docs-brand__logo" aria-hidden="true" focusable="false">
          <defs>
            <linearGradient id="logoGradientA" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#1a4a55"></stop><stop offset="100%" stop-color="#0d2a32"></stop></linearGradient>
            <linearGradient id="logoGradientB" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stop-color="#1a5565"></stop><stop offset="100%" stop-color="#4ab8d5"></stop></linearGradient>
          </defs>
